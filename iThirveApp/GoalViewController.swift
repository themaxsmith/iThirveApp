...
class GoalViewController: UIViewController, DateTimePickerDelegate {
    ...
    func setNot(){
        notify(title: "It has been 1 day", text: "What progress have you made towards your goals?", day: 1)
        notify(title: "What have you completed?", text: "It has been 10 days", day: 10)
        notify(title: "What have you completed?", text: "It has been 20 days", day: 20)
        notify(title: "You have 24 hours left", text: "How close are you to achieving all your goals?", day: 30)
        notify(title: "Your Goal Cycle Ended!", text: "Self assess your achievement of your goals and set new goals. ", day: 31)
